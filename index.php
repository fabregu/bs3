			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-3 col-sm-push-9 col-md-4 col-md-push-8 col-lg-6 col-lg-push-6 date-info">
						<h3 class="highlighted"><strong>W21</strong> 13/14 abril</h3>
					...
					<div class="col-xs-12 col-sm-9 col-sm-pull-3 col-md-8 col-md-pull-4 col-lg-6 col-lg-pull-6 main-info">
						<h2>Desarrolla front-end like a boss aprendiendo BOOSTRAP 3!</h2>
						<p>Disfruta de un fin de semana diferente aprendiendo con 
							<a href="#">Marcos Gonzáles</a> y <a href="#">Armando Sotoca</a></p>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-3 col-md-4 col-lg-6 date-info">
						<h3 class="highlighted"><strong>W38 </strong>19/20 abril</h3>
					...
					<div class="col-xs-12 col-sm-9 col-md-8 col-lg-6 main-info">
						...
						<p>Sorprendete de lo fácil que puede ser crear apps para iOS y Android con este workshop impartido por 
							<a href="#">Alberto Ordás</a></p>
							<a href="detail.php" class="more-info-link">quiero más información</a>
							<a href="detail.php" class="btn btn-custom">ME APUNTO!</a>
					</div>
				</div>
